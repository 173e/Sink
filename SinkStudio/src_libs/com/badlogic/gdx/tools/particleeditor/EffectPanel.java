...
class EffectPanel extends JPanel {
	...
	void openEffect () {
		FileDialog dialog = new FileDialog(SinkStudio.frame, "Open Effect", FileDialog.LOAD);
	...
	void saveEffect () {
		FileDialog dialog = new FileDialog(SinkStudio.frame, "Save Effect", FileDialog.SAVE);
		if (lastDir != null) dialog.setDirectory(lastDir);
		dialog.setVisible(true);

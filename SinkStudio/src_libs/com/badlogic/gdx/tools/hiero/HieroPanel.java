...
public class HieroPanel extends JPanel {
	...
	public HieroPanel(Frame _parent) {
		super(new BorderLayout());
		parent = _parent;
		initialize();
		fontRenderer = new FontRenderer();
		SinkStudio.log("Creating Hiero Canvas");
	...
	public void destroyCanvas(){
		SinkStudio.log("Destroying Hiero Canvas");
		if(canvas != null){
	...
	private void initializeEvents () {
		...
		browseButton.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent evt) {
				FileDialog dialog = new FileDialog(parent, "Choose TrueType font file", FileDialog.LOAD);
		...
		openMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent evt) {
				FileDialog dialog = new FileDialog(parent, "Open Hiero settings file", FileDialog.LOAD);
				dialog.setLocationRelativeTo(null);
		...
		saveMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent evt) {
				FileDialog dialog = new FileDialog(parent, "Save Hiero settings file", FileDialog.SAVE);
				dialog.setLocationRelativeTo(null);
				dialog.setFile("*.hiero");
		...
		saveBMFontMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent evt) {
				FileDialog dialog = new FileDialog(parent, "Save BMFont files", FileDialog.SAVE);
				dialog.setLocationRelativeTo(null);
				dialog.setFile("*.fnt");
	...
	class FontRenderer implements ApplicationListener {

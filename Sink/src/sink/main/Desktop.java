 ...
 * <p>
 * Just specify the Desktop class as the Main file and when you export your game to jar add
 * the manifest entry Main-Class: sink.main.Desktop for it to work
 */
public final class Desktop {
	...
	public static void main(String[] argc) {
		String text = "";
		try {
			InputStream input = Desktop.class.getClassLoader().getResourceAsStream("config.json");
			if(input != null){

...
************************************************************************************************************/
	...
	public static void $musicPlay(String filename){
		if(Config.isMusic){
			...
			if(musicMap.containsKey(filename)){
				Panel.$log("Music: playing "+filename);
				...
				Panel.$log("Music File Not Found: "+filename);
			}
		}
	}
	...
	public static void $musicPause(){
		if(currentMusic != null)
			if(currentMusic.isPlaying()){
				Panel.$log("Music: pausing "+currentMusicName);
				currentMusic.pause();
			}
	}
	...
	public static void $musicResume(){
		if(currentMusic != null)
			if(!currentMusic.isPlaying()){
				Panel.$log("Music: resuming "+currentMusicName);
				currentMusic.play();
			}
		else
	...
	public static void $musicStop(){
		if(currentMusic != null){
			Panel.$log("Music: stoping "+currentMusicName);
			currentMusic.stop();
			currentMusic = null;
		}
	}
...
************************************************************************************************************/
	...
	public static void $soundDispose(){
		Panel.$log("Sound:"+"Disposing Sound");
		if(currentSound != null)
...
************************************************************************************************************/
	...
	public static BitmapFont $font(String fontname){
		if(fontMap.containsKey(fontname)){
			...
			Panel.$log("Font File Not Found: "+fontname);
			return null;
		}
	}
...
************************************************************************************************************/
	...
	public static TextureRegion $tex(String textureregionName){
		if(texMap.containsKey(textureregionName)){
			...
			Panel.$log("TextureRegion Not Found: "+textureregionName);
			return null;
		}
	}
...
************************************************************************************************************/
	...
	public static Animation $anim(String animationBaseName){
		if(animMap.containsKey(animationBaseName)){
			...
			Panel.$log("Animation Not Found: "+animationBaseName);
			return null;
		}
	}
	...
	private static void loadAnimations() {
		...
		for(String name: texRegionsName) {
			...
			// Row Single Png Image Texture Animations
				...
				Panel.$log("Loading Row Animation: "+name);
...
************************************************************************************************************/
	...
	public static void debugTextures(){
		Panel.$log("Debugging Textures------------------");
		for(String na: texMap.keys)
			Panel.$log(na);
		Panel.$log("END Debugging Textures------------------");
	}
	
	public static void debugAnimations(){
		Panel.$log("Debugging Animations------------------");
		for(String na: animMap.keys)
			Panel.$log(na);
		Panel.$log("END Debugging Animations------------------");
	}
	
	public static void debugFonts(){
		Panel.$log("Debugging Fonts------------------");
		for(String na: fontMap.keys)
			Panel.$log(na);
		Panel.$log("END Debugging Fonts------------------");
	}
	
	public static void debugSounds(){
		Panel.$log("Debugging Sounds------------------");
		for(String na: soundMap.keys)
			Panel.$log(na);
		Panel.$log("END Debugging Sounds------------------");
	}
	
	public static void debugMusics(){
		Panel.$log("Debugging Musics------------------");
		for(String na: musicMap.keys)
			Panel.$log(na);
		Panel.$log("END Debugging Musics------------------");
	}

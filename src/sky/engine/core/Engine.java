...
public abstract class Engine implements ApplicationListener {
	...
	public void create() {
		...
		$stage.setCamera($camera);
 		...
 		Panel.$log("TotalTime: "+getScreenTime(Config.readTotalTime()));
	}
	...
	@Override
	public void resume() {
		Panel.$log("Engine: Resume");
		$musicResume();
	}

	@Override
	public void dispose() {
		Panel.$log("Engine: Disposing");

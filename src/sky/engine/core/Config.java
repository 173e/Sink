...
import static sky.engine.core.Asset.$musicVolume;
...
public final class Config {
	// Desktop Settings
	public static final String title = "SkyEngine";
    ...
    public static boolean isPan = prefs.getBoolean(PANSCROLL, true);
    public static boolean isDrag = prefs.getBoolean(DRAGSCROLL, true);
    
    public static float speedPan = prefs.getFloat(PANSPEED, 5f);
    public static float speedDrag = prefs.getFloat(DRAGSPEED, 5f);
    
    public static boolean isKeyboard = prefs.getBoolean(KEYBOARD, true);
